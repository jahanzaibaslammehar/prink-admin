                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap" width="30%">Color Name</th>
                                <th class="whitespace-nowrap" width="20%">Color Code</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $d->color_id }}</td>
                                <td>
                                    <i style="color:{{ $d->color_code }}" class="mr-3">&#9679;</i>
                                    {{ $d->color_name }}
                                </td>
                                <td>{{ $d->color_code }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <a class="flex items-center mr-3" href="{{ route('colors.edit', $d->color_id) }}">
                                            <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                        </a>
                                        <a class="delete-confirm flex items-center text-danger" href="{{ route('colors.delete', $d->color_id) }}">
