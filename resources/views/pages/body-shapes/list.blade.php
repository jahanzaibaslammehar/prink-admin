                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="whitespace-nowrap" width="25%">Body Shape Type</th>
                                <th class="whitespace-nowrap" width="25%">Gender</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <a class="flex items-center mr-3" href="{{ route('body-types.edit', $d->body_shape_id) }}">
                                            <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                        </a>
                                        <a class="delete-confirm flex items-center text-danger" href="{{ route('body-types.delete', $d->body_shape_id) }}">
